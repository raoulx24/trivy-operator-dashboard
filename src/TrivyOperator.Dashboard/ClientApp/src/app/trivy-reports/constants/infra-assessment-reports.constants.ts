...
export const infraAssessmentReportColumns: readonly TrivyTableColumn[] = [
  {
    field: 'resourceName',
    header: 'Name',
    isFilterable: true,
...
export const infraAssessmentReportDetailColumns: readonly TrivyTableColumn[] = [
  {
    field: 'severityId',
    header: 'Sev',
    isFilterable: true,
...
export const infraAssessmentReportDenormalizedColumns: readonly TrivyTableColumn[] = [
  {
    field: 'resourceName',
    header: 'Name',
    isFilterable: true,
...
export const infraAssessmentReportComparedTableColumns: readonly TrivyTableColumn[] = [
  {
    field: 'first',
    header: '1st',
    isFilterable: false,
