...
public static class ExposedSecretReportMappings
{
        ...
        ExposedSecretReport report)
    {
        return new ExposedSecretReportDto(
            ...
            ResourceName: occurrence.Resource.Name.Value,
            ResourceKind: occurrence.Resource.Kind.Value,
            ResourceContainerName: occurrence.Resource.Container?.Value ?? string.Empty,
        ...
        this ReportImageOccurrence occurrence)
    {
        return new ExposedSecretReportResourceDto(
            Name: occurrence.Resource.Name.Value,
            Kind: occurrence.Resource.Kind.Value,
            ContainerName: occurrence.Resource.Container?.Value ?? string.Empty
        );
    }
